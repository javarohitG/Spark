...
public class SocketServer {
	...
	public static void main(String[] args) {
    	...
    	Path path = FileSystems.getDefault()
    			.getPath("C:\\Users\\Manish\\Desktop\\spark_Eclipse\\SparkTraing\\Streaming_data\\", 
    					"streamingtweets.txt");
...
/* Run command
 * 
 * java -cp C:/Users/Manish/Desktop/spark_Eclipse/SparkTraing/target/classes com.manish.SparkStreaming.SocketServer
   java -cp java_Eclipse__Folder/target/classes packagename.classname
*/
